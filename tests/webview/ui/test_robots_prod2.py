...
def test_robots_production(
    webview_base_url, archive_base_url, robots_production_list, robots_staging_list, selenium
):
    ...
    if "//cnx.org/" in webview_base_url:
        print("KKKKKKKK: ", robots_production_list)
        # print("KKKKKKKK: ", webview_robots_text)
        # assert robots_production_list == webview_robots_text

        # assert "\nUser-agent: *\nAllow: /\n" in archive_robots_text

    else:
        print("KKKKKKKK: ", robots_staging_list)
        # print("KKKKKKKK: ", webview_robots_text)
        # "//staging.cnx.org/" in webview_base_url:
        # assert robots_staging_list == webview_robots_text
