...
class BooksHomePageLayout:
    ...
    try:
        ...
        eyes.open(driver=driver, app_name=App_Name, test_name='Book icons', viewport_size={'width': 1400, 'height': 820})
...
# finds element by xpath, scrolls it into view and clicks "Show more" links
        ...
        element2 = driver.find_element_by_xpath("//*[@id='featured-books']/div/div[1]/div/div[1]/div/a[1]")
        sleep(1)
        element2.click()
